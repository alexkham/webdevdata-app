...
const functionsDb=[
    {
      ...
      docstring: "Returns the absolute value of a number.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns an AsyncIterator for an AsyncIterable object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns True if all elements of the iterable are true (or if the iterable is empty).",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Returns the next item from an async iterator.",
      decorators: [],
      main_category: "Iteration",
      sub_category: "Asynchronous",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns True if any element of the iterable is true. If the iterable is empty, return False.",
      decorators: [],
      main_category: "Iteration",
      sub_category: "Evaluation",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns a string containing a printable representation of an object, escaping non-ASCII characters.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the binary representation of an integer.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a Boolean value, i.e. one of True or False.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a new array of bytes. The bytearray type is a mutable sequence of integers in the range 0 <= x < 256.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a new 'bytes' object, which is an immutable sequence of integers in the range 0 <= x < 256.",
      decorators: [],
      main_category: "Data Types",
      sub_category: "Byte Sequences",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns True if the object argument appears callable, False if not.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a string of one character whose Unicode code point is the integer i.",
      decorators: [],
      main_category: "String Operations",
    ...
    },
    {
      ...
      docstring: "Transforms a method into a class method.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Compiles the source into a code or AST object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Creates a complex number with the value real + imag*1j or convert a string or number to a complex number.",
      decorators: [],
      main_category: "Number Operations",
    ...
    },
    {
      ...
      docstring: "Creates a new dictionary.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a tuple of the quotient and remainder when dividing a by b.",
      decorators: [],
      main_category: "Mathematical Operations",
    ...
    },
    {
      ...
      docstring: "Returns an enumerate object.",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Evaluates a Python expression as a string and return the result.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Executes Python code dynamically.",
      decorators: [],
      main_category: "Code Execution",
    ...
    },
    {
      ...
      docstring: "Constructs an iterator from elements of iterable for which function returns True.",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Converts a string or number to a floating point number.",
      decorators: [],
      main_category: "Type Conversion",
      sub_category: "Numeric",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns value.__format__(format_spec).",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns an immutable set object initialized from iterable.",
      decorators: [],
      main_category: "Data Structures",
      sub_category: "Set",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Gets a named attribute from an object; getattr(x, 'y') is equivalent to x.y.",
      decorators: [],
      main_category: "Object Manipulation",
      sub_category: "Attribute Operations",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns the dictionary containing the current scope's global variables.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns whether the object has an attribute with the given name.",
      decorators: [],
      main_category: "Object Manipulation",
      sub_category: "Attribute Operations",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the hash value of the object (if it has one).",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Invokes the built-in help system.",
      decorators: [],
      main_category: "Introspection",
    ...
    },
    {
      ...
      docstring: "Returns the hexadecimal representation of an integer.",
      decorators: [],
      main_category: "Type Conversion",
      sub_category: "Numeric",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the identity of an object.",
      decorators: [],
      main_category: "Object Operations",
    ...
    },
    {
      ...
      docstring: "Reads a string from standard input.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Converts a number or string to an integer, or return 0 if no arguments are given.",
      decorators: [],
      main_category: "Type Conversion",
      sub_category: "Numeric",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns whether an object is an instance of a class or of a subclass thereof.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns whether 'class' is a derived from another class or is the same class.",
      decorators: [],
      main_category: "Type Checking",
    ...
    },
    {
      ...
      docstring: "Returns an iterator object.",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Returns the length (the number of items) of an object.",
      decorators: [],
      main_category: "Object Operations",
      sub_category: "Size",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a dictionary containing the current scope's local variables.",
      decorators: [],
      main_category: "Introspection",
      sub_category: "Namespace",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Applies function to every item of iterable and return an iterator of the results.",
      decorators: [],
      main_category: "Iteration",
      sub_category: "Mapping",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the largest item in an iterable or the largest of two or more arguments.",
      decorators: [],
      main_category: "Mathematical Operations",
    ...
    },
    {
      ...
      docstring: "Creates a memory view object from a bytes-like object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the smallest item in an iterable or the smallest of two or more arguments.",
      decorators: [],
      main_category: "Mathematical Operations",
      sub_category: "Comparison",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Retrieves the next item from the iterator.",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Returns the octal representation of an integer.",
      decorators: [],
      main_category: "Type Conversion",
      sub_category: "Numeric",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Opens file and return a corresponding file object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the Unicode code point for a one-character string.",
      decorators: [],
      main_category: "String Operations",
      sub_category: "Character Conversion",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns base to the power exp; if mod is present, return base to the power exp, modulo mod.",
      decorators: [],
      main_category: "Mathematical Operations",
    ...
    },
    {
      ...
      docstring: "Prints objects to the text stream file, separated by sep and followed by end.",
      decorators: [],
      main_category: "Input/Output",
    ...
    },
    {
      ...
      docstring: "Returns an object that produces a sequence of integers from start to stop by step.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a string containing a printable representation of an object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a reverse iterator over the values of the given sequence.",
      decorators: [],
      main_category: "Iteration",
    ...
    },
    {
      ...
      docstring: "Rounds a number to a given precision in decimal digits.",
      decorators: [],
      main_category: "Mathematical Operations",
    ...
    },
    {
      ...
      docstring: "Returns a new set object, optionally with elements taken from iterable.",
      decorators: [],
      main_category: "Data Structures",
      sub_category: "Set",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Sets a named attribute on an object with the given value.",
      decorators: [],
      main_category: "Object Manipulation",
      sub_category: "Attribute Operations",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Creates a slice object. Used for extended slicing (e.g. a[start:stop:step]).",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns a new sorted list from the items in iterable.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Transforms a method into a static method.",
      decorators: [],
      main_category: "Object-Oriented Programming",
    ...
    },
    {
      ...
      docstring: "Returns a string version of object.",
      decorators: [],
      main_category: "Type Conversion",
      sub_category: "String Conversion",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the sum of a 'start' value (default: 0) plus an iterable of numbers.",
      decorators: [],
      main_category: "Mathematical Operations",
    ...
    },
    {
      ...
      docstring: "Returns a proxy object that delegates method calls to a parent or sibling class of type.",
      decorators: [],
      main_category: "Object-Oriented Programming",
    ...
    },
    {
      ...
      docstring: "Returns a tuple whose items are the same and in the same order as iterable's items.",
      decorators: [],
      main_category: "Data Structures",
      sub_category: "Sequence",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the type of an object, or create a new type object.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the __dict__ attribute for a module, class, instance, or any other object with a __dict__ attribute.",
      decorators: [],
      main_category: "Introspection",
    ...
    },
    {
      ...
      docstring: "Returns an iterator of tuples where the i-th tuple contains the i-th element from each of the argument sequences or iterables.",
      decorators: [],
      main_category: "Iteration",
    ...
    //     }
    //   ],
    //   docstring: "Imports a module. This is an advanced function that is not needed in everyday Python programming.",
    //   decorators: [],
    ...
    // },
    {
      ...
      parameters: [],
      docstring: "Removes all items from the dictionary.",
      decorators: [],
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Removes all items from the list.",
      decorators: [],
      main_category: "Data Structure Operations",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Removes all elements from this set.",
      decorators: [],
      main_category: "Data Structure Operations",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a shallow copy of the dictionary.",
      decorators: [],
      main_category: "Data Structure Operations",
      sub_category: "Dictionary Manipulation",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a shallow copy of the list.",
      decorators: [],
      main_category: "Data Structure Operations",
      sub_category: "List Manipulation",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a shallow copy of the set.",
      decorators: [],
      main_category: "Data Structure Operations",
      sub_category: "Set Manipulation",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Creates a new dictionary with keys from iterable and values set to value.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the value for key if key is in the dictionary, else default.",
      decorators: [],
      main_category: "Dictionary Operations",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a new view of the dictionary's items ((key, value) pairs).",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "View",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a new view of the dictionary's keys.",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "View",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Removes specified key and return the corresponding value.",
      decorators: [],
      main_category: "Dictionary Operations",
    ...
    },
    {
      ...
      docstring: "Removes and return item at index (default last).",
      decorators: [],
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Removes and return an arbitrary set element. Raises KeyError if the set is empty.",
      decorators: [],
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Removes and return a (key, value) pair as a 2-tuple.",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Inserts key with a value of default if key is not in the dictionary.",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Updates the dictionary with the key/value pairs from other, overwriting existing keys.",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a new view of the dictionary's values.",
      decorators: [],
      main_category: "Dictionary Operations",
      sub_category: "View",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the number of times a specified value occurs in a tuple.",
      decorators: [],
    ...
    },
    {
      ...
      docstring: "Returns the number of times a specified value occurs in a list.",
      decorators: [],
      main_category: "List Operations",
      sub_category: "Counting",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the number of non-overlapping occurrences of substring sub in string.",
      decorators: [],
      main_category: "String Operations",
      sub_category: "Counting",
      data_type_manipulated: [
      ...
      version_added: "1.0",
      deprecated: false,
      extended_description: `@[count]@ is a Python string method that returns number of non-overlapping occurrences of substring. Optional start and end parameters specify search range. Works with [find](!/python/functions/find) and [index](!/python/functions/index) for more complex substring operations. Partners with [split](!/python/functions/split) for string tokenization and counting elements. Useful in text analysis, character frequency counting, and input validation. Handles empty substrings following specific rules. Essential for text processing and pattern frequency analysis. Returns zero if substring not found.
...
`,
    ...
    },
    {
      ...
      docstring: "Returns the index of the first occurrence of the specified value.",
      decorators: [],
      main_category: "Tuple Operations",
    ...
    },
    {
      ...
      docstring: "Returns the lowest index where the substring is found.",
      decorators: [],
      main_category: "String Operations",
      sub_category: "Searching",
      data_type_manipulated: [
      ...
      version_added: "1.0",
      deprecated: false,
      extended_description: `@[index]@ is a Python string method that finds first occurrence of substring and returns its position. Similar to [find](!/python/functions/find) but raises ValueError when substring not found, making it stricter. Works with [rindex](!/python/functions/rindex) for searching from right side. Accepts optional start and end parameters for search range. Partners with [split](!/python/functions/split) and [partition](!/python/functions/partition) for text parsing. Often used when substring must exist, making error handling explicit. Essential for string validation and strict text processing workflows.
`,
    ...
    },
    {
      ...
      docstring: "Adds an element to the set.",
      decorators: [],
      main_category: "Set Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Returns the difference of two or more sets as a new set.",
      decorators: [],
      main_category: "Set Operations",
      sub_category: "Comparison",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Removes all elements of another set from this set.",
      decorators: [],
      main_category: "Set Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      docstring: "Removes an element from a set if it is a member.",
      decorators: [],
      main_category: "Set Operations",
      sub_category: "Modification",
      data_type_manipulated: [
    ...
    },
    {
      ...
      svg:[
        {tab:`parameters`,
            svg_diagram:`
<svg aria-roledescription="flowchart-v2" role="graphics-document document" viewBox="0 0 491.82293701171875 988" style="width:35%; max-width: none;" class="flowchart" xmlns="http://www.w3.org/2000/svg" width="100%" id="export-svg"><style xmlns="http://www.w3.org/1999/xhtml">@import url("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"); p {margin: 0;}</style><style>#export-svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;fill:#000000;}#export-svg .error-icon{fill:#552222;}#export-svg .error-text{fill:#552222;stroke:#552222;}#export-svg .edge-thickness-normal{stroke-width:1px;}#export-svg .edge-thickness-thick{stroke-width:3.5px;}#export-svg .edge-pattern-solid{stroke-dasharray:0;}#export-svg .edge-thickness-invisible{stroke-width:0;fill:none;}#export-svg .edge-pattern-dashed{stroke-dasharray:3;}#export-svg .edge-pattern-dotted{stroke-dasharray:2;}#export-svg .marker{fill:#666;stroke:#666;}#export-svg .marker.cross{stroke:#666;}#export-svg svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;}#export-svg p{margin:0;}#export-svg .label{font-family:"trebuchet ms",verdana,arial,sans-serif;color:#000000;}#export-svg .cluster-label text{fill:#333;}#export-svg .cluster-label span{color:#333;}#export-svg .cluster-label span p{background-color:transparent;}#export-svg .label text,#export-svg span{fill:#000000;color:#000000;}#export-svg .node rect,#export-svg .node circle,#export-svg .node ellipse,#export-svg .node polygon,#export-svg .node path{fill:#eee;stroke:#999;stroke-width:1px;}#export-svg .rough-node .label text,#export-svg .node .label text,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-anchor:middle;}#export-svg .node .katex path{fill:#000;stroke:#000;stroke-width:1px;}#export-svg .rough-node .label,#export-svg .node .label,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-align:center;}#export-svg .node.clickable{cursor:pointer;}#export-svg .root .anchor path{fill:#666!important;stroke-width:0;stroke:#666;}#export-svg .arrowheadPath{fill:#333333;}#export-svg .edgePath .path{stroke:#666;stroke-width:2.0px;}#export-svg .flowchart-link{stroke:#666;fill:none;}#export-svg .edgeLabel{background-color:white;text-align:center;}#export-svg .edgeLabel p{background-color:white;}#export-svg .edgeLabel rect{opacity:0.5;background-color:white;fill:white;}#export-svg .labelBkg{background-color:rgba(255, 255, 255, 0.5);}#export-svg .cluster rect{fill:hsl(0, 0%, 98.9215686275%);stroke:#707070;stroke-width:1px;}#export-svg .cluster text{fill:#333;}#export-svg .cluster span{color:#333;}#export-svg div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:12px;background:hsl(-160, 0%, 93.3333333333%);border:1px solid #707070;border-radius:2px;pointer-events:none;z-index:100;}#export-svg .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#000000;}#export-svg rect.text{fill:none;stroke-width:0;}#export-svg .icon-shape,#export-svg .image-shape{background-color:white;text-align:center;}#export-svg .icon-shape p,#export-svg .image-shape p{background-color:white;padding:2px;}#export-svg .icon-shape rect,#export-svg .image-shape rect{opacity:0.5;background-color:white;fill:white;}#export-svg .node .neo-node{stroke:#999;}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].cluster rect,#export-svg [data-look="neo"].node polygon{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].node polygon,#export-svg [data-look="neo"].node path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node .neo-line path{stroke:hsl(0, 0%, 83.3333333333%);filter:none;}#export-svg [data-look="neo"].node circle{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node circle .state-start{fill:#000000;}#export-svg [data-look="neo"].statediagram-cluster rect{fill:#eee;stroke:url(#export-svg-gradient);stroke-width:1px;}#export-svg [data-look="neo"].icon-shape .icon{fill:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].icon-shape .icon-neo path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}</style><g><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointEnd"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 0 L 10 5 L 0 10 z"/></marker><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="4.5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointStart"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 5 L 10 10 L 10 0 z"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="11" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleEnd"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="-1" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleStart"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="12" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossEnd"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="-1" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossStart"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><g class="root"><g class="clusters"/><g class="edgePaths"><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6OTcuMTcyNTM1Mzk4MzA3NTIsInkiOjQ2OC41fSx7IngiOjE5OC44MjI5MjE3NTI5Mjk3LCJ5Ijo1NC41fSx7IngiOjI2MS4xOTI3MTA4NzY0NjQ4NCwieSI6NTQuNX1d" data-id="L_Start_FirstLower_0" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_FirstLower_0" d="M97.17253539830752,468.5L196.89080699967263,62.36908477708951Q198.8229217529297,54.5 206.9257337739984,54.5L230.00781631469727,54.5L257.19271087646484,54.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTAwLjE5MjIxMDQ2MjgwNSwieSI6NDY4LjV9LHsieCI6MTk4LjgyMjkyMTc1MjkyOTcsInkiOjE5Ny41fSx7IngiOjIzNS4xMTQ1ODU4NzY0NjQ4NCwieSI6MTk3LjV9XQ==" data-id="L_Start_FirstUpper_1" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_FirstUpper_1" d="M100.192210462805,468.5L195.84162775062202,205.6914716426289Q198.8229217529297,197.5 207.5400498121123,197.5L216.96875381469727,197.5L231.11458587646484,197.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTA4LjgzODEyMDUwMDg5Mzg3LCJ5Ijo0NjguNX0seyJ4IjoxOTguODIyOTIxNzUyOTI5NywieSI6MzQwLjV9LHsieCI6MjUyLjYxOTc5Njc1MjkyOTcsInkiOjM0MC41fV0=" data-id="L_Start_RestUpper_2" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_RestUpper_2" d="M108.83812050089387,468.5L192.5841387592551,349.37443448314866Q198.8229217529297,340.5 209.6708708972547,340.5L225.7213592529297,340.5L248.6197967529297,340.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTczLjgyMjkyMTc1MjkyOTcsInkiOjQ5NH0seyJ4IjoxOTguODIyOTIxNzUyOTI5NywieSI6NDk0fSx7IngiOjIyMy44MjI5MjE3NTI5Mjk3LCJ5Ijo0OTR9XQ==" data-id="L_Start_LeadSpace_3" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_LeadSpace_3" d="M173.8229217529297,494L198.8229217529297,494L211.3229217529297,494L219.8229217529297,494"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTA4LjgzODEyMDUwMDg5Mzg3LCJ5Ijo1MTkuNX0seyJ4IjoxOTguODIyOTIxNzUyOTI5NywieSI6NjQ3LjV9LHsieCI6MjU4LjgzMzMzNTg3NjQ2NDg0LCJ5Ijo2NDcuNX1d" data-id="L_Start_FirstNum_4" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_FirstNum_4" d="M108.83812050089387,519.5L192.5841387592551,638.6255655168513Q198.8229217529297,647.5 209.6708708972547,647.5L228.82812881469727,647.5L254.83333587646484,647.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTAwLjE5MjIxMDQ2MjgwNSwieSI6NTE5LjV9LHsieCI6MTk4LjgyMjkyMTc1MjkyOTcsInkiOjc5MC41fSx7IngiOjI1OC40OTQ3OTY3NTI5Mjk3LCJ5Ijo3OTAuNX1d" data-id="L_Start_Special_5" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Special_5" d="M100.192210462805,519.5L195.84162775062202,782.3085283573711Q198.8229217529297,790.5 207.5400498121123,790.5L228.6588592529297,790.5L254.4947967529297,790.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6OTcuMTcyNTM1Mzk4MzA3NTIsInkiOjUxOS41fSx7IngiOjE5OC44MjI5MjE3NTI5Mjk3LCJ5Ijo5MzMuNX0seyJ4IjoyNTkuMjM5NTg1ODc2NDY0ODQsInkiOjkzMy41fV0=" data-id="L_Start_Empty_6" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Empty_6" d="M97.17253539830752,519.5L196.89080699967263,925.6309152229105Q198.8229217529297,933.5 206.9257337739984,933.5L229.03125381469727,933.5L255.23958587646484,933.5"/></g><g class="edgeLabels"><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_FirstLower_0" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_FirstUpper_1" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_RestUpper_2" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_LeadSpace_3" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_FirstNum_4" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Special_5" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Empty_6" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g></g><g class="nodes"><g transform="translate(90.91146087646484, 494)" data-look="neo" data-et="node" data-node="true" data-id="Start" id="flowchart-Start-230" class="node default"><rect stroke="url(#gradient)" height="51" width="165.8229217529297" y="-25.5" x="-82.91146087646484" data-id="Start" style="" class="basic label-container"/><g transform="translate(-52.911460876464844, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="105.82292175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>string.capitalize()</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 54.5)" data-look="neo" data-et="node" data-node="true" data-id="FirstLower" id="flowchart-FirstLower-231" class="node default"><rect stroke="url(#gradient)" height="93" width="185.2604217529297" y="-46.5" x="-92.63021087646484" data-id="FirstLower" style="" class="basic label-container"/><g transform="translate(-62.630210876464844, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="125.26042175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>First char lowercase<br />'hello' → 'Hello'<br />'word' → 'Word'</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 197.5)" data-look="neo" data-et="node" data-node="true" data-id="FirstUpper" id="flowchart-FirstUpper-233" class="node default"><rect stroke="url(#gradient)" height="93" width="237.4166717529297" y="-46.5" x="-118.70833587646484" data-id="FirstUpper" style="" class="basic label-container"/><g transform="translate(-88.70833587646484, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="177.4166717529297"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>First char already uppercase<br />'Hello' → 'Hello'<br />No change needed</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 340.5)" data-look="neo" data-et="node" data-node="true" data-id="RestUpper" id="flowchart-RestUpper-235" class="node default"><rect stroke="url(#gradient)" height="93" width="202.40625" y="-46.5" x="-101.203125" data-id="RestUpper" style="" class="basic label-container"/><g transform="translate(-71.203125, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="142.40625"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Other chars uppercase<br />'hELLO' → 'Hello'<br />'wORLD' → 'World'</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 494)" data-look="neo" data-et="node" data-node="true" data-id="LeadSpace" id="flowchart-LeadSpace-237" class="node default"><rect stroke="url(#gradient)" height="114" width="260" y="-57" x="-130" data-id="LeadSpace" style="" class="basic label-container"/><g transform="translate(-100, -42)" style="" class="label"><rect/><foreignObject height="84" width="200"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table; white-space: break-spaces; line-height: 1.5; max-width: 200px; text-align: center; width: 200px;"><span class="nodeLabel"><p>Leading whitespace<br />' hello' → ' hello'<br />Space remains, next char capitalized</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 647.5)" data-look="neo" data-et="node" data-node="true" data-id="FirstNum" id="flowchart-FirstNum-239" class="node default"><rect stroke="url(#gradient)" height="93" width="189.9791717529297" y="-46.5" x="-94.98958587646484" data-id="FirstNum" style="" class="basic label-container"/><g transform="translate(-64.98958587646484, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="129.9791717529297"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>First char numeric<br />'123abc' → '123abc'<br />Numbers unchanged</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 790.5)" data-look="neo" data-et="node" data-node="true" data-id="Special" id="flowchart-Special-241" class="node default"><rect stroke="url(#gradient)" height="93" width="190.65625" y="-46.5" x="-95.328125" data-id="Special" style="" class="basic label-container"/><g transform="translate(-65.328125, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="130.65625"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>First char special<br />'!hello' → '!hello'<br />'@World' → '@world'</p></span></div></foreignObject></g></g><g transform="translate(353.8229217529297, 933.5)" data-look="neo" data-et="node" data-node="true" data-id="Empty" id="flowchart-Empty-243" class="node default"><rect stroke="url(#gradient)" height="93" width="189.1666717529297" y="-46.5" x="-94.58333587646484" data-id="Empty" style="" class="basic label-container"/><g transform="translate(-64.58333587646484, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="129.1666717529297"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Empty string<br />'' → ''<br />Returns empty string</p></span></div></foreignObject></g></g></g></g></g><linearGradient y2="0%" x2="100%" y1="0%" x1="0%" gradientUnits="objectBoundingBox" id="export-svg-gradient"><stop stop-opacity="1" stop-color="hsl(0, 0%, 83.3333333333%)" offset="0%"/><stop stop-opacity="1" stop-color="hsl(0, 0%, 88.9215686275%)" offset="100%"/></linearGradient></svg>`,
            explanation:``
        },
        {tab:``,
            svg_diagram:``,
      ...
      @[capitalize]@ is a Python string method that converts strings first character to uppercase and remaining characters to lowercase. Works with [upper](!/python/functions/upper) and [lower](!/python/functions/lower) for case transformations. Similar to [title](!/python/functions/title) but applies only to first character instead of each word. Useful for proper formatting of names, sentences, and text styling. Often used with [strip](!/python/functions/strip) for text cleanup and [casefold](!/python/functions/casefold) for more aggressive Unicode case handling. Creates new string instance, preserving original data integrity. Essential for consistent text formatting in user interfaces and content management.
    ...
    },
    {
      ...
      extended_description: `@[casefold]@ is a Python string method providing aggressive Unicode case folding. More thorough than [lower](!/python/functions/lower) for international text comparison, it handles special cases like German ß to ss conversion. Works alongside [upper](!/python/functions/upper) and [title](!/python/functions/title) in text processing workflows. While [lower](!/python/functions/lower) suffices for ASCII, [casefold]@ excels in multilingual applications and locale-aware comparisons. Partners with [strip](!/python/functions/strip) for text cleanup. Returns new string instance, keeping original intact. Essential for international text processing and case-insensitive comparisons across languages.
    ...
    },
    {
      ...
      extended_description: `@[endswith]@ is a Python string method that checks if string ends with specified suffix, returning True or False. Works with [startswith](!/python/functions/startswith) for comprehensive prefix/suffix validation. Accepts tuple of suffixes to check multiple options. Optional start and end parameters allow checking specific string portions. Partners with [strip](!/python/functions/strip) for clean comparisons and [rfind](!/python/functions/rfind) for more detailed suffix handling. Essential for file extension validation, URL processing, and text pattern matching. Common in input validation and string filtering workflows.
    ...
    },
    {
      ...
      extended_description: `@[find]@ is a Python string method that searches for first occurrence of a substring and returns its index position. Partners with [index](!/python/functions/index) but returns -1 instead of raising error when substring not found. Works with [rfind](!/python/functions/rfind) for searching from right side. Can specify optional start and end positions for targeted search range. Often used with [string](!/python/functions/string) slicing and [split](!/python/functions/split) operations in text processing. Essential for text parsing, data extraction, and pattern matching tasks. Creates foundation for more complex string manipulations.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Searching",
    ...
    },
    {
      ...
      svg:[
        {tab:`parameters`,
            svg_diagram:`
<svg aria-roledescription="flowchart-v2" role="graphics-document document" viewBox="0 0 438.40625 967" style="width:35%; max-width: none;" class="flowchart" xmlns="http://www.w3.org/2000/svg" width="100%" id="export-svg"><style xmlns="http://www.w3.org/1999/xhtml">@import url("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"); p {margin: 0;}</style><style>#export-svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;fill:#000000;}#export-svg .error-icon{fill:#552222;}#export-svg .error-text{fill:#552222;stroke:#552222;}#export-svg .edge-thickness-normal{stroke-width:1px;}#export-svg .edge-thickness-thick{stroke-width:3.5px;}#export-svg .edge-pattern-solid{stroke-dasharray:0;}#export-svg .edge-thickness-invisible{stroke-width:0;fill:none;}#export-svg .edge-pattern-dashed{stroke-dasharray:3;}#export-svg .edge-pattern-dotted{stroke-dasharray:2;}#export-svg .marker{fill:#666;stroke:#666;}#export-svg .marker.cross{stroke:#666;}#export-svg svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;}#export-svg p{margin:0;}#export-svg .label{font-family:"trebuchet ms",verdana,arial,sans-serif;color:#000000;}#export-svg .cluster-label text{fill:#333;}#export-svg .cluster-label span{color:#333;}#export-svg .cluster-label span p{background-color:transparent;}#export-svg .label text,#export-svg span{fill:#000000;color:#000000;}#export-svg .node rect,#export-svg .node circle,#export-svg .node ellipse,#export-svg .node polygon,#export-svg .node path{fill:#eee;stroke:#999;stroke-width:1px;}#export-svg .rough-node .label text,#export-svg .node .label text,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-anchor:middle;}#export-svg .node .katex path{fill:#000;stroke:#000;stroke-width:1px;}#export-svg .rough-node .label,#export-svg .node .label,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-align:center;}#export-svg .node.clickable{cursor:pointer;}#export-svg .root .anchor path{fill:#666!important;stroke-width:0;stroke:#666;}#export-svg .arrowheadPath{fill:#333333;}#export-svg .edgePath .path{stroke:#666;stroke-width:2.0px;}#export-svg .flowchart-link{stroke:#666;fill:none;}#export-svg .edgeLabel{background-color:white;text-align:center;}#export-svg .edgeLabel p{background-color:white;}#export-svg .edgeLabel rect{opacity:0.5;background-color:white;fill:white;}#export-svg .labelBkg{background-color:rgba(255, 255, 255, 0.5);}#export-svg .cluster rect{fill:hsl(0, 0%, 98.9215686275%);stroke:#707070;stroke-width:1px;}#export-svg .cluster text{fill:#333;}#export-svg .cluster span{color:#333;}#export-svg div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:12px;background:hsl(-160, 0%, 93.3333333333%);border:1px solid #707070;border-radius:2px;pointer-events:none;z-index:100;}#export-svg .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#000000;}#export-svg rect.text{fill:none;stroke-width:0;}#export-svg .icon-shape,#export-svg .image-shape{background-color:white;text-align:center;}#export-svg .icon-shape p,#export-svg .image-shape p{background-color:white;padding:2px;}#export-svg .icon-shape rect,#export-svg .image-shape rect{opacity:0.5;background-color:white;fill:white;}#export-svg .node .neo-node{stroke:#999;}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].cluster rect,#export-svg [data-look="neo"].node polygon{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].node polygon,#export-svg [data-look="neo"].node path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node .neo-line path{stroke:hsl(0, 0%, 83.3333333333%);filter:none;}#export-svg [data-look="neo"].node circle{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node circle .state-start{fill:#000000;}#export-svg [data-look="neo"].statediagram-cluster rect{fill:#eee;stroke:url(#export-svg-gradient);stroke-width:1px;}#export-svg [data-look="neo"].icon-shape .icon{fill:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].icon-shape .icon-neo path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}</style><g><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointEnd"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 0 L 10 5 L 0 10 z"/></marker><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="4.5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointStart"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 5 L 10 10 L 10 0 z"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="11" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleEnd"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="-1" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleStart"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="12" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossEnd"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="-1" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossStart"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><g class="root"><g class="clusters"/><g class="edgePaths"><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODQuMTI2OTEyMTUwMzQ5NjUsInkiOjQ1OH0seyJ4IjoxNzMuOTA2MjUsInkiOjU0LjV9LHsieCI6MjI3LjQ1ODMzNTg3NjQ2NDg0LCJ5Ijo1NC41fV0=" data-id="L_Start_AllLower_0" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_AllLower_0" d="M84.12691215034965,458L172.1704603945762,62.3012505166993Q173.90625,54.5 181.89827572434538,54.5L200.68229293823242,54.5L223.45833587646484,54.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODYuOTYzODA1NzI1NTI0NDgsInkiOjQ1OH0seyJ4IjoxNzMuOTA2MjUsInkiOjE5Ny41fSx7IngiOjIyMS43MjM5NjA4NzY0NjQ4NCwieSI6MTk3LjV9XQ==" data-id="L_Start_MixedCase_1" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_MixedCase_1" d="M86.96380572552448,458L171.19834375089556,205.61352365094248Q173.90625,197.5 182.4597301273132,197.5L197.81510543823242,197.5L217.72396087646484,197.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6OTUuNDc0NDg2NDUxMDQ4OTUsInkiOjQ1OH0seyJ4IjoxNzMuOTA2MjUsInkiOjM0MC41fSx7IngiOjIyNS42MzU0MTQxMjM1MzUxNiwieSI6MzQwLjV9XQ==" data-id="L_Start_AllUpper_2" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_AllUpper_2" d="M95.47448645104895,458L168.02012079435147,349.3181133557203Q173.90625,340.5 184.50840262010132,340.5L199.77083206176758,340.5L221.63541412353516,340.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MTQ4LjkwNjI1LCJ5Ijo0ODMuNX0seyJ4IjoxNzMuOTA2MjUsInkiOjQ4My41fSx7IngiOjIxNC4zMTc3MTA4NzY0NjQ4NCwieSI6NDgzLjV9XQ==" data-id="L_Start_Numbers_3" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Numbers_3" d="M148.90625,483.5L173.90625,483.5L194.11198043823242,483.5L210.31771087646484,483.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6OTUuNDc0NDg2NDUxMDQ4OTUsInkiOjUwOX0seyJ4IjoxNzMuOTA2MjUsInkiOjYyNi41fSx7IngiOjIxMS40MjE4NzUsInkiOjYyNi41fV0=" data-id="L_Start_Special_4" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Special_4" d="M95.47448645104895,509L168.69924572706614,618.6992956120657Q173.90625,626.5 183.28515625,626.5L192.6640625,626.5L207.421875,626.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODYuOTYzODA1NzI1NTI0NDgsInkiOjUwOX0seyJ4IjoxNzMuOTA2MjUsInkiOjc2OS41fSx7IngiOjE5OC45MDYyNSwieSI6NzY5LjV9XQ==" data-id="L_Start_Spaces_5" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Spaces_5" d="M86.96380572552448,509L171.9275917456996,763.5714747607277Q173.90625,769.5 180.15625,769.5L186.40625,769.5L194.90625,769.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODQuMTI2OTEyMTUwMzQ5NjUsInkiOjUwOX0seyJ4IjoxNzMuOTA2MjUsInkiOjkxMi41fSx7IngiOjIyMC4wNzI5MTQxMjM1MzUxNiwieSI6OTEyLjV9XQ==" data-id="L_Start_Empty_6" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_Empty_6" d="M84.12691215034965,509L172.1704603945762,904.6987494833007Q173.90625,912.5 181.89827572434538,912.5L196.98958206176758,912.5L216.07291412353516,912.5"/></g><g class="edgeLabels"><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_AllLower_0" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_MixedCase_1" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_AllUpper_2" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Numbers_3" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Special_4" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Spaces_5" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_Empty_6" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g></g><g class="nodes"><g transform="translate(78.453125, 483.5)" data-look="neo" data-et="node" data-node="true" data-id="Start" id="flowchart-Start-342" class="node default"><rect stroke="url(#gradient)" height="51" width="140.90625" y="-25.5" x="-70.453125" data-id="Start" style="" class="basic label-container"/><g transform="translate(-40.453125, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="80.90625"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>string.lower()</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 54.5)" data-look="neo" data-et="node" data-node="true" data-id="AllLower" id="flowchart-AllLower-343" class="node default"><rect stroke="url(#gradient)" height="93" width="174.39583587646484" y="-46.5" x="-87.19791793823242" data-id="AllLower" style="" class="basic label-container"/><g transform="translate(-57.19791793823242, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="114.39583587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Already lowercase<br />'hello' → 'hello'<br />No changes made</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 197.5)" data-look="neo" data-et="node" data-node="true" data-id="MixedCase" id="flowchart-MixedCase-345" class="node default"><rect stroke="url(#gradient)" height="93" width="185.86458587646484" y="-46.5" x="-92.93229293823242" data-id="MixedCase" style="" class="basic label-container"/><g transform="translate(-62.93229293823242, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="125.86458587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Mixed case<br />'HeLLo' → 'hello'<br />'PyThOn' → 'python'</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 340.5)" data-look="neo" data-et="node" data-node="true" data-id="AllUpper" id="flowchart-AllUpper-347" class="node default"><rect stroke="url(#gradient)" height="93" width="178.0416717529297" y="-46.5" x="-89.02083587646484" data-id="AllUpper" style="" class="basic label-container"/><g transform="translate(-59.020835876464844, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="118.04167175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>All uppercase<br />'HELLO' → 'hello'<br />'WORLD' → 'world'</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 483.5)" data-look="neo" data-et="node" data-node="true" data-id="Numbers" id="flowchart-Numbers-349" class="node default"><rect stroke="url(#gradient)" height="93" width="200.67709350585938" y="-46.5" x="-100.33854675292969" data-id="Numbers" style="" class="basic label-container"/><g transform="translate(-70.33854675292969, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="140.67709350585938"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Contains numbers<br />'Hello123' → 'hello123'<br />Numbers unchanged</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 626.5)" data-look="neo" data-et="node" data-node="true" data-id="Special" id="flowchart-Special-351" class="node default"><rect stroke="url(#gradient)" height="93" width="206.46875" y="-46.5" x="-103.234375" data-id="Special" style="" class="basic label-container"/><g transform="translate(-73.234375, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="146.46875"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Special characters<br />'Hello!' → 'hello!'<br />'@WORLD' → '@world'</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 769.5)" data-look="neo" data-et="node" data-node="true" data-id="Spaces" id="flowchart-Spaces-353" class="node default"><rect stroke="url(#gradient)" height="93" width="231.5" y="-46.5" x="-115.75" data-id="Spaces" style="" class="basic label-container"/><g transform="translate(-85.75, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="171.5"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Whitespace<br />'Hello World' → 'hello world'<br />Spaces preserved</p></span></div></foreignObject></g></g><g transform="translate(314.65625, 912.5)" data-look="neo" data-et="node" data-node="true" data-id="Empty" id="flowchart-Empty-355" class="node default"><rect stroke="url(#gradient)" height="93" width="189.1666717529297" y="-46.5" x="-94.58333587646484" data-id="Empty" style="" class="basic label-container"/><g transform="translate(-64.58333587646484, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="129.1666717529297"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Empty string<br />'' → ''<br />Returns empty string</p></span></div></foreignObject></g></g></g></g></g><linearGradient y2="0%" x2="100%" y1="0%" x1="0%" gradientUnits="objectBoundingBox" id="export-svg-gradient"><stop stop-opacity="1" stop-color="hsl(0, 0%, 83.3333333333%)" offset="0%"/><stop stop-opacity="1" stop-color="hsl(0, 0%, 88.9215686275%)" offset="100%"/></linearGradient></svg>`,
            explanation:``
        },
        {tab:``,
            svg_diagram:``,
      ...
      extended_description: `@[lower]@ function in Python is a string manipulation function that creates a new string with all characters converted to lowercase. Essential for text processing, data cleaning, and case-insensitive comparisons. Unlike [upper](!/python/functions/upper), it transforms all uppercase letters to their lowercase equivalents while leaving other characters unchanged. Often used in data preprocessing, user input validation, and text normalization tasks. Frequently paired with [strip](!/python/functions/strip) for comprehensive string cleaning or [casefold](!/python/functions/casefold) when dealing with international text. Works seamlessly with ASCII and Unicode characters, though for more specialized Unicode handling, consider using [casefold](!/python/functions/casefold). The transformation is non-destructive, creating a new string instance rather than modifying the original.
...
`,
    ...
    },
    {
      ...
      extended_description: `@[partition]@ is a Python string method that splits string into 3-part tuple (before_separator, separator, after_separator) based on first occurrence of separator. Belongs to string division family with [split](!/python/functions/split) and [rpartition](!/python/functions/rpartition). Unlike [split](!/python/functions/split), always returns three elements, making it ideal for structured parsing. Works with [strip](!/python/functions/strip) for clean text processing. If separator not found, returns original string and two empty strings. Essential for stable parsing where separator position and surrounding content are important. Common in parsing key-value pairs and structured text processing.
...
`,
    ...
    },
    {
      ...
      docstring: "Returns a copy with all occurrences of substring old replaced by new.",
    ...
    },
    {
      ...
      docstring: "Returns the highest index in the string where substring sub is found.",
      extended_description: `@[rfind]@ is a Python string method that searches for the last occurrence of a substring and returns its index position. Similar to [find](!/python/functions/find) but searches from right to left. Partners with [rindex](!/python/functions/rindex) but returns -1 instead of raising error when substring not found. Works with optional start and end parameters for search range specification. Often used with [string](!/python/functions/string) slicing and [split](!/python/functions/split) operations. Useful in text parsing, particularly when processing file paths, URLs, or finding last occurrences of delimiters.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Searching",
    ...
    },
    {
      ...
      docstring: "Returns the highest index in the string where substring sub is found.",
      extended_description: `@[rindex]@ is a Python string method that returns position of last occurrence of substring. Similar to [rfind](!/python/functions/rfind) but raises ValueError when substring not found, offering stricter validation. Works with [index](!/python/functions/index) for bidirectional search. Takes optional start and end parameters for search range. Partners with [split](!/python/functions/split) and [rpartition](!/python/functions/rpartition) for text parsing. Used when substring must exist and searching from right is needed. Essential for validation and strict text processing from string's end.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Searching",
    ...
    },
    {
      ...
      docstring: "Returns right-justified string of length width.",
    ...
    },
    {
      ...
      docstring: "Partition the string into three parts using the given separator.",
      extended_description: `@[rpartition]@ is a Python string method that splits string into 3-part tuple (before_separator, separator, after_separator) based on last occurrence of separator. Belongs to string division family with [split](!/python/functions/split) and [partition](!/python/functions/partition). Like [partition](!/python/functions/partition), always returns three elements but searches from right side. Works with [strip](!/python/functions/strip) for clean text processing. If separator not found, returns two empty strings and original string. Essential for parsing from right side where separator position matters. Common in file path processing, URL parsing, and handling nested structures.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Splitting",
    ...
    },
    {
      ...
      svg:[
        {tab:`parameters`,
            svg_diagram:`
<svg aria-roledescription="flowchart-v2" role="graphics-document document" viewBox="0 0 902.510498046875 712.5" style="width:70%;max-width: none;" class="flowchart" xmlns="http://www.w3.org/2000/svg" width="100%" id="export-svg"><style xmlns="http://www.w3.org/1999/xhtml">@import url("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"); p {margin: 0;}</style><style>#export-svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;fill:#000000;}#export-svg .error-icon{fill:#552222;}#export-svg .error-text{fill:#552222;stroke:#552222;}#export-svg .edge-thickness-normal{stroke-width:1px;}#export-svg .edge-thickness-thick{stroke-width:3.5px;}#export-svg .edge-pattern-solid{stroke-dasharray:0;}#export-svg .edge-thickness-invisible{stroke-width:0;fill:none;}#export-svg .edge-pattern-dashed{stroke-dasharray:3;}#export-svg .edge-pattern-dotted{stroke-dasharray:2;}#export-svg .marker{fill:#666;stroke:#666;}#export-svg .marker.cross{stroke:#666;}#export-svg svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;}#export-svg p{margin:0;}#export-svg .label{font-family:"trebuchet ms",verdana,arial,sans-serif;color:#000000;}#export-svg .cluster-label text{fill:#333;}#export-svg .cluster-label span{color:#333;}#export-svg .cluster-label span p{background-color:transparent;}#export-svg .label text,#export-svg span{fill:#000000;color:#000000;}#export-svg .node rect,#export-svg .node circle,#export-svg .node ellipse,#export-svg .node polygon,#export-svg .node path{fill:#eee;stroke:#999;stroke-width:1px;}#export-svg .rough-node .label text,#export-svg .node .label text,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-anchor:middle;}#export-svg .node .katex path{fill:#000;stroke:#000;stroke-width:1px;}#export-svg .rough-node .label,#export-svg .node .label,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-align:center;}#export-svg .node.clickable{cursor:pointer;}#export-svg .root .anchor path{fill:#666!important;stroke-width:0;stroke:#666;}#export-svg .arrowheadPath{fill:#333333;}#export-svg .edgePath .path{stroke:#666;stroke-width:2.0px;}#export-svg .flowchart-link{stroke:#666;fill:none;}#export-svg .edgeLabel{background-color:white;text-align:center;}#export-svg .edgeLabel p{background-color:white;}#export-svg .edgeLabel rect{opacity:0.5;background-color:white;fill:white;}#export-svg .labelBkg{background-color:rgba(255, 255, 255, 0.5);}#export-svg .cluster rect{fill:hsl(0, 0%, 98.9215686275%);stroke:#707070;stroke-width:1px;}#export-svg .cluster text{fill:#333;}#export-svg .cluster span{color:#333;}#export-svg div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:12px;background:hsl(-160, 0%, 93.3333333333%);border:1px solid #707070;border-radius:2px;pointer-events:none;z-index:100;}#export-svg .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#000000;}#export-svg rect.text{fill:none;stroke-width:0;}#export-svg .icon-shape,#export-svg .image-shape{background-color:white;text-align:center;}#export-svg .icon-shape p,#export-svg .image-shape p{background-color:white;padding:2px;}#export-svg .icon-shape rect,#export-svg .image-shape rect{opacity:0.5;background-color:white;fill:white;}#export-svg .node .neo-node{stroke:#999;}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].cluster rect,#export-svg [data-look="neo"].node polygon{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].node polygon,#export-svg [data-look="neo"].node path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node .neo-line path{stroke:hsl(0, 0%, 83.3333333333%);filter:none;}#export-svg [data-look="neo"].node circle{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node circle .state-start{fill:#000000;}#export-svg [data-look="neo"].statediagram-cluster rect{fill:#eee;stroke:url(#export-svg-gradient);stroke-width:1px;}#export-svg [data-look="neo"].icon-shape .icon{fill:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].icon-shape .icon-neo path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}</style><g><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointEnd"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 0 L 10 5 L 0 10 z"/></marker><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="4.5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointStart"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 5 L 10 10 L 10 0 z"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="11" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleEnd"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="-1" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleStart"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="12" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossEnd"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="-1" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossStart"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><g class="root"><g class="clusters"/><g class="edgePaths"><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODMuODU4MzQyOTQ0MjE2NjQsInkiOjI1OS4yNX0seyJ4IjoxNjQuNjA0MTcxNzUyOTI5NywieSI6NTQuNX0seyJ4IjoxODkuNjA0MTcxNzUyOTI5NywieSI6NTQuNX1d" data-id="L_Start_NoSep_0" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_NoSep_0" d="M83.85834294421664,259.25L162.31126149077937,60.31421211599007Q164.6041717529297,54.5 170.8541717529297,54.5L177.1041717529297,54.5L185.6041717529297,54.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODguODg2NDcxNDc4MDkyNTYsInkiOjMxMC4yNX0seyJ4IjoxNjQuNjA0MTcxNzUyOTI5NywieSI6NDM4LjI1fSx7IngiOjIwMC41LCJ5Ijo0MzguMjV9XQ==" data-id="L_Start_WithSep_1" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_WithSep_1" d="M88.88647147809256,310.25L160.0352194660603,430.5262327620028Q164.6041717529297,438.25 173.57812881469727,438.25L182.55208587646484,438.25L196.5,438.25"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzczLjM0Mzc1LCJ5Ijo1NC41fSx7IngiOjM5OC4zNDM3NSwieSI6NTQuNX0seyJ4Ijo0MjYuNSwieSI6NTQuNX1d" data-id="L_NoSep_Default_2" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_NoSep_Default_2" d="M373.34375,54.5L398.34375,54.5L412.421875,54.5L422.5,54.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6Mjk0LjQxNzE5NDg1MTA1ODMsInkiOjQxMi43NX0seyJ4IjozOTguMzQzNzUsInkiOjIwOH0seyJ4Ijo0MjMuMzQzNzUsInkiOjIwOH1d" data-id="L_WithSep_Found_3" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_Found_3" d="M294.4171948510583,412.75L395.51493014084883,213.5731748765378Q398.34375,208 404.59375,208L410.84375,208L419.34375,208"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzIwLjMwMzY2MjgwMDI0NTI2LCJ5Ijo0MTIuNzV9LHsieCI6Mzk4LjM0Mzc1LCJ5IjozNjEuNX0seyJ4Ijo0NDIuOTU4MzM1ODc2NDY0ODQsInkiOjM2MS41fV0=" data-id="L_WithSep_NotFound_4" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_NotFound_4" d="M320.30366280024526,412.75L389.02075097478587,367.6225418523588Q398.34375,361.5 409.4973964691162,361.5L420.6510429382324,361.5L438.95833587646484,361.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzIwLjMwMzY2MjgwMDI0NTI2LCJ5Ijo0NjMuNzV9LHsieCI6Mzk4LjM0Mzc1LCJ5Ijo1MTV9LHsieCI6NDMxLjc2NTYyNSwieSI6NTE1fV0=" data-id="L_WithSep_MaxSplit_5" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_MaxSplit_5" d="M320.30366280024526,463.75L391.3596639231145,510.41345449135395Q398.34375,515 406.69921875,515L415.0546875,515L427.765625,515"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6Mjk1LjAzNTY0Mjg5MDgsInkiOjQ2My43NX0seyJ4IjozOTguMzQzNzUsInkiOjY1OH0seyJ4Ijo0NzAuODE3NzEwODc2NDY0ODQsInkiOjY1OH1d" data-id="L_WithSep_Empty_6" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_Empty_6" d="M295.0356428908,463.75L393.78494199279646,649.4280836211312Q398.34375,658 408.052533695853,658L434.5807304382324,658L466.81771087646484,658"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6NjM1Ljg2OTc4OTEyMzUzNTIsInkiOjY1OH0seyJ4Ijo3MDguMzQzNzUsInkiOjY1OH0seyJ4Ijo3MzMuMzQzNzUsInkiOjY1OH1d" data-id="L_Empty_Error_7" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Empty_Error_7" d="M635.8697891235352,658L708.34375,658L720.84375,658L729.34375,658"/></g><g class="edgeLabels"><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_NoSep_0" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_WithSep_1" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_NoSep_Default_2" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_Found_3" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_NotFound_4" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_MaxSplit_5" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_Empty_6" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Empty_Error_7" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g></g><g class="nodes"><g transform="translate(73.80208587646484, 284.75)" data-look="neo" data-et="node" data-node="true" data-id="Start" id="flowchart-Start-112" class="node default"><rect stroke="url(#gradient)" height="51" width="131.6041717529297" y="-25.5" x="-65.80208587646484" data-id="Start" style="" class="basic label-container"/><g transform="translate(-35.802085876464844, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="71.60417175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Input String</p></span></div></foreignObject></g></g><g transform="translate(281.47396087646484, 54.5)" data-look="neo" data-et="node" data-node="true" data-id="NoSep" id="flowchart-NoSep-113" class="node default"><rect stroke="url(#gradient)" height="51" width="183.73958587646484" y="-25.5" x="-91.86979293823242" data-id="NoSep" style="" class="basic label-container"/><g transform="translate(-61.86979293823242, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="123.73958587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>No Separator Given</p></span></div></foreignObject></g></g><g transform="translate(281.47396087646484, 438.25)" data-look="neo" data-et="node" data-node="true" data-id="WithSep" id="flowchart-WithSep-115" class="node default"><rect stroke="url(#gradient)" height="51" width="161.9479217529297" y="-25.5" x="-80.97396087646484" data-id="WithSep" style="" class="basic label-container"/><g transform="translate(-50.973960876464844, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="101.94792175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Separator Given</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 54.5)" data-look="neo" data-et="node" data-node="true" data-id="Default" id="flowchart-Default-117" class="node default"><rect stroke="url(#gradient)" height="93" width="253.6875" y="-46.5" x="-126.84375" data-id="Default" style="" class="basic label-container"/><g transform="translate(-96.84375, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="193.6875"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Splits on ANY Whitespace<br />RIGHT to LEFT<br />'Hello   World' → ['Hello', 'World']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 208)" data-look="neo" data-et="node" data-node="true" data-id="Found" id="flowchart-Found-119" class="node default"><rect stroke="url(#gradient)" height="114" width="260" y="-57" x="-130" data-id="Found" style="" class="basic label-container"/><g transform="translate(-100, -42)" style="" class="label"><rect/><foreignObject height="84" width="200"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table; white-space: break-spaces; line-height: 1.5; max-width: 200px; text-align: center; width: 200px;"><span class="nodeLabel"><p>Separator Found<br />'a,b,c'.rsplit(',') → ['a', 'b', 'c']<br />Same as split() when no maxsplit</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 361.5)" data-look="neo" data-et="node" data-node="true" data-id="NotFound" id="flowchart-NotFound-121" class="node default"><rect stroke="url(#gradient)" height="93" width="220.77084350585938" y="-46.5" x="-110.38542175292969" data-id="NotFound" style="" class="basic label-container"/><g transform="translate(-80.38542175292969, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="160.77084350585938"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Separator Not Found<br />'apple'.rsplit(',') → ['apple']<br />Same as split()</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 515)" data-look="neo" data-et="node" data-node="true" data-id="MaxSplit" id="flowchart-MaxSplit-123" class="node default"><rect stroke="url(#gradient)" height="114" width="243.15625" y="-57" x="-121.578125" data-id="MaxSplit" style="" class="basic label-container"/><g transform="translate(-91.578125, -42)" style="" class="label"><rect/><foreignObject height="84" width="183.15625"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>With maxsplit=1<br />Starts from RIGHT<br />'a,b,c'.rsplit(',', 1) → ['a,b', 'c']<br />Different from split(): ['a', 'b,c']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 658)" data-look="neo" data-et="node" data-node="true" data-id="Empty" id="flowchart-Empty-125" class="node default"><rect stroke="url(#gradient)" height="72" width="165.05208587646484" y="-36" x="-82.52604293823242" data-id="Empty" style="" class="basic label-container"/><g transform="translate(-52.52604293823242, -21)" style="" class="label"><rect/><foreignObject height="42" width="105.05208587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Empty Separator<br />'python'.rsplit('')</p></span></div></foreignObject></g></g><g transform="translate(813.9270858764648, 658)" data-look="neo" data-et="node" data-node="true" data-id="Error" id="flowchart-Error-127" class="node default"><rect stroke="url(#gradient)" height="93" width="161.1666717529297" y="-46.5" x="-80.58333587646484" data-id="Error" style="" class="basic label-container"/><g transform="translate(-50.583335876464844, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="101.16667175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>ValueError:<br />empty separator<br />Same as split()</p></span></div></foreignObject></g></g></g></g></g><linearGradient y2="0%" x2="100%" y1="0%" x1="0%" gradientUnits="objectBoundingBox" id="export-svg-gradient"><stop stop-opacity="1" stop-color="hsl(0, 0%, 83.3333333333%)" offset="0%"/><stop stop-opacity="1" stop-color="hsl(0, 0%, 88.9215686275%)" offset="100%"/></linearGradient></svg>`,
            explanation:``
        },
        {tab:``,
            svg_diagram:``,
      ...
      docstring: "Returns a list of the words in the string, using sep as the delimiter string.",
      extended_description: `@[rsplit]@ is a Python string method that splits string into list of substrings from right to left. Belongs to string partitioning family with [split](!/python/functions/split) and [rpartition](!/python/functions/rpartition), offering right-side directionality. Works with [strip](!/python/functions/strip) for clean text processing and [join](!/python/functions/join) for string reconstruction. Without arguments, splits on whitespace like [split](!/python/functions/split). Optional maxsplit parameter is particularly useful for right-side limited splits, making it ideal for parsing file paths, URLs, or nested identifiers. Returns list of split strings in original order. Essential for right-to-left text processing workflows.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Splitting",
    ...
    },
    {
      ...
      docstring: "Returns a copy of the string with trailing characters removed.",
...
<svg aria-roledescription="flowchart-v2" role="graphics-document document" viewBox="0 0 902.510498046875 597" style="max-width: 902.510498046875px;" class="flowchart" xmlns="http://www.w3.org/2000/svg" width="100%" id="export-svg"><style xmlns="http://www.w3.org/1999/xhtml">@import url("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"); p {margin: 0;}</style><style>#export-svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;fill:#000000;}#export-svg .error-icon{fill:#552222;}#export-svg .error-text{fill:#552222;stroke:#552222;}#export-svg .edge-thickness-normal{stroke-width:1px;}#export-svg .edge-thickness-thick{stroke-width:3.5px;}#export-svg .edge-pattern-solid{stroke-dasharray:0;}#export-svg .edge-thickness-invisible{stroke-width:0;fill:none;}#export-svg .edge-pattern-dashed{stroke-dasharray:3;}#export-svg .edge-pattern-dotted{stroke-dasharray:2;}#export-svg .marker{fill:#666;stroke:#666;}#export-svg .marker.cross{stroke:#666;}#export-svg svg{font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:14px;}#export-svg p{margin:0;}#export-svg .label{font-family:"trebuchet ms",verdana,arial,sans-serif;color:#000000;}#export-svg .cluster-label text{fill:#333;}#export-svg .cluster-label span{color:#333;}#export-svg .cluster-label span p{background-color:transparent;}#export-svg .label text,#export-svg span{fill:#000000;color:#000000;}#export-svg .node rect,#export-svg .node circle,#export-svg .node ellipse,#export-svg .node polygon,#export-svg .node path{fill:#eee;stroke:#999;stroke-width:1px;}#export-svg .rough-node .label text,#export-svg .node .label text,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-anchor:middle;}#export-svg .node .katex path{fill:#000;stroke:#000;stroke-width:1px;}#export-svg .rough-node .label,#export-svg .node .label,#export-svg .image-shape .label,#export-svg .icon-shape .label{text-align:center;}#export-svg .node.clickable{cursor:pointer;}#export-svg .root .anchor path{fill:#666!important;stroke-width:0;stroke:#666;}#export-svg .arrowheadPath{fill:#333333;}#export-svg .edgePath .path{stroke:#666;stroke-width:2.0px;}#export-svg .flowchart-link{stroke:#666;fill:none;}#export-svg .edgeLabel{background-color:white;text-align:center;}#export-svg .edgeLabel p{background-color:white;}#export-svg .edgeLabel rect{opacity:0.5;background-color:white;fill:white;}#export-svg .labelBkg{background-color:rgba(255, 255, 255, 0.5);}#export-svg .cluster rect{fill:hsl(0, 0%, 98.9215686275%);stroke:#707070;stroke-width:1px;}#export-svg .cluster text{fill:#333;}#export-svg .cluster span{color:#333;}#export-svg div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:12px;background:hsl(-160, 0%, 93.3333333333%);border:1px solid #707070;border-radius:2px;pointer-events:none;z-index:100;}#export-svg .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#000000;}#export-svg rect.text{fill:none;stroke-width:0;}#export-svg .icon-shape,#export-svg .image-shape{background-color:white;text-align:center;}#export-svg .icon-shape p,#export-svg .image-shape p{background-color:white;padding:2px;}#export-svg .icon-shape rect,#export-svg .image-shape rect{opacity:0.5;background-color:white;fill:white;}#export-svg .node .neo-node{stroke:#999;}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].cluster rect,#export-svg [data-look="neo"].node polygon{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node rect,#export-svg [data-look="neo"].node polygon,#export-svg [data-look="neo"].node path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node .neo-line path{stroke:hsl(0, 0%, 83.3333333333%);filter:none;}#export-svg [data-look="neo"].node circle{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].node circle .state-start{fill:#000000;}#export-svg [data-look="neo"].statediagram-cluster rect{fill:#eee;stroke:url(#export-svg-gradient);stroke-width:1px;}#export-svg [data-look="neo"].icon-shape .icon{fill:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg [data-look="neo"].icon-shape .icon-neo path{stroke:url(#export-svg-gradient);filter:drop-shadow( 1px 2px 2px rgba(185,185,185,1));}#export-svg :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}</style><g><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointEnd"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 0 L 10 5 L 0 10 z"/></marker><marker orient="auto" markerHeight="8" markerWidth="8" markerUnits="userSpaceOnUse" refY="5" refX="4.5" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-pointStart"><path style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 0 5 L 10 10 L 10 0 z"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="11" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleEnd"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5" refX="-1" viewBox="0 0 10 10" class="marker flowchart-v2" id="export-svg_flowchart-v2-circleStart"><circle style="stroke-width: 1; stroke-dasharray: 1, 0;" class="arrowMarkerPath" r="5" cy="5" cx="5"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="12" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossEnd"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><marker orient="auto" markerHeight="11" markerWidth="11" markerUnits="userSpaceOnUse" refY="5.2" refX="-1" viewBox="0 0 11 11" class="marker cross flowchart-v2" id="export-svg_flowchart-v2-crossStart"><path style="stroke-width: 2; stroke-dasharray: 1, 0;" class="arrowMarkerPath" d="M 1,1 l 9,9 M 10,1 l -9,9"/></marker><g class="root"><g class="clusters"/><g class="edgePaths"><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6ODUuNzY4MjUyMjMyMjc4MDQsInkiOjIxMn0seyJ4IjoxNjQuNjA0MTcxNzUyOTI5NywieSI6NDR9LHsieCI6MTg5LjYwNDE3MTc1MjkyOTcsInkiOjQ0fV0=" data-id="L_Start_NoSep_0" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_NoSep_0" d="M85.76825223227804,212L161.94908788386212,49.658005801359444Q164.6041717529297,44 170.8541717529297,44L177.1041717529297,44L185.6041717529297,44"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6OTEuMjc3MjA0MjkwNDI2LCJ5IjoyNjN9LHsieCI6MTY0LjYwNDE3MTc1MjkyOTcsInkiOjM3MH0seyJ4IjoyMDAuNSwieSI6MzcwfV0=" data-id="L_Start_WithSep_1" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Start_WithSep_1" d="M91.277204290426,263L159.53123695180508,362.59748435665364Q164.6041717529297,370 173.57812881469727,370L182.55208587646484,370L196.5,370"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzczLjM0Mzc1LCJ5Ijo0NH0seyJ4IjozOTguMzQzNzUsInkiOjQ0fSx7IngiOjQyNi41LCJ5Ijo0NH1d" data-id="L_NoSep_Default_2" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_NoSep_Default_2" d="M373.34375,44L398.34375,44L412.421875,44L422.5,44"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6Mjk2Ljg3NTQwNTk1NDc2MDIsInkiOjM0NC41fSx7IngiOjM5OC4zNDM3NSwieSI6MTc2LjV9LHsieCI6NDIzLjM0Mzc1LCJ5IjoxNzYuNX1d" data-id="L_WithSep_Found_3" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_Found_3" d="M296.8754059547602,344.5L395.1125157890982,181.84991826800166Q398.34375,176.5 404.59375,176.5L410.84375,176.5L419.34375,176.5"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzMwLjMyOTM2NDUyNjQ2NzI2LCJ5IjozNDQuNX0seyJ4IjozOTguMzQzNzUsInkiOjMwOX0seyJ4Ijo0NDUuMjg2NDYwODc2NDY0ODQsInkiOjMwOX1d" data-id="L_WithSep_NotFound_4" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_NotFound_4" d="M330.32936452646726,344.5L387.9399690121816,314.4302368902719Q398.34375,309 410.0794277191162,309L421.8151054382324,309L441.28646087646484,309"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6MzMwLjMyOTM2NDUyNjQ2NzI2LCJ5IjozOTUuNX0seyJ4IjozOTguMzQzNzUsInkiOjQzMX0seyJ4Ijo0MzYuNzkxNjY0MTIzNTM1MTYsInkiOjQzMX1d" data-id="L_WithSep_MaxSplit_5" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_MaxSplit_5" d="M330.32936452646726,395.5L389.82264692539565,426.5524238432446Q398.34375,431 407.9557285308838,431L417.5677070617676,431L432.79166412353516,431"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6Mjk3Ljc1OTA5NTQyNjQ2NTY1LCJ5IjozOTUuNX0seyJ4IjozOTguMzQzNzUsInkiOjU1M30seyJ4Ijo0NzAuODE3NzEwODc2NDY0ODQsInkiOjU1M31d" data-id="L_WithSep_Empty_6" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_WithSep_Empty_6" d="M297.75909542646565,395.5L392.7429811120513,544.2300628401817Q398.34375,553 408.74953732837525,553L434.5807304382324,553L466.81771087646484,553"/><path marker-end="url(#export-svg_flowchart-v2-pointEnd)" data-points="W3sieCI6NjM1Ljg2OTc4OTEyMzUzNTIsInkiOjU1M30seyJ4Ijo3MDguMzQzNzUsInkiOjU1M30seyJ4Ijo3MzMuMzQzNzUsInkiOjU1M31d" data-id="L_Empty_Error_7" data-et="edge" data-edge="true" style="" class="edge-thickness-normal edge-pattern-solid edge-thickness-normal edge-pattern-solid flowchart-link" id="L_Empty_Error_7" d="M635.8697891235352,553L708.34375,553L720.84375,553L729.34375,553"/></g><g class="edgeLabels"><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_NoSep_0" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Start_WithSep_1" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_NoSep_Default_2" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_Found_3" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_NotFound_4" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_MaxSplit_5" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_WithSep_Empty_6" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g><g class="edgeLabel"><g transform="translate(0, 0)" data-id="L_Empty_Error_7" class="label"><foreignObject height="0" width="0"><div class="labelBkg" xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="edgeLabel"></span></div></foreignObject></g></g></g><g class="nodes"><g transform="translate(73.80208587646484, 237.5)" data-look="neo" data-et="node" data-node="true" data-id="Start" id="flowchart-Start-128" class="node default"><rect stroke="url(#gradient)" height="51" width="131.6041717529297" y="-25.5" x="-65.80208587646484" data-id="Start" style="" class="basic label-container"/><g transform="translate(-35.802085876464844, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="71.60417175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Input String</p></span></div></foreignObject></g></g><g transform="translate(281.47396087646484, 44)" data-look="neo" data-et="node" data-node="true" data-id="NoSep" id="flowchart-NoSep-129" class="node default"><rect stroke="url(#gradient)" height="51" width="183.73958587646484" y="-25.5" x="-91.86979293823242" data-id="NoSep" style="" class="basic label-container"/><g transform="translate(-61.86979293823242, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="123.73958587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>No Separator Given</p></span></div></foreignObject></g></g><g transform="translate(281.47396087646484, 370)" data-look="neo" data-et="node" data-node="true" data-id="WithSep" id="flowchart-WithSep-131" class="node default"><rect stroke="url(#gradient)" height="51" width="161.9479217529297" y="-25.5" x="-80.97396087646484" data-id="WithSep" style="" class="basic label-container"/><g transform="translate(-50.973960876464844, -10.5)" style="" class="label"><rect/><foreignObject height="21" width="101.94792175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Separator Given</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 44)" data-look="neo" data-et="node" data-node="true" data-id="Default" id="flowchart-Default-133" class="node default"><rect stroke="url(#gradient)" height="72" width="253.6875" y="-36" x="-126.84375" data-id="Default" style="" class="basic label-container"/><g transform="translate(-96.84375, -21)" style="" class="label"><rect/><foreignObject height="42" width="193.6875"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Splits on ANY Whitespace<br />'Hello   World' → ['Hello', 'World']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 176.5)" data-look="neo" data-et="node" data-node="true" data-id="Found" id="flowchart-Found-135" class="node default"><rect stroke="url(#gradient)" height="93" width="260" y="-46.5" x="-130" data-id="Found" style="" class="basic label-container"/><g transform="translate(-100, -31.5)" style="" class="label"><rect/><foreignObject height="63" width="200"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table; white-space: break-spaces; line-height: 1.5; max-width: 200px; text-align: center; width: 200px;"><span class="nodeLabel"><p>Separator Found<br />'apple,orange'.split(',') → ['apple', 'orange']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 309)" data-look="neo" data-et="node" data-node="true" data-id="NotFound" id="flowchart-NotFound-137" class="node default"><rect stroke="url(#gradient)" height="72" width="216.11459350585938" y="-36" x="-108.05729675292969" data-id="NotFound" style="" class="basic label-container"/><g transform="translate(-78.05729675292969, -21)" style="" class="label"><rect/><foreignObject height="42" width="156.11459350585938"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Separator Not Found<br />'apple'.split(',') → ['apple']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 431)" data-look="neo" data-et="node" data-node="true" data-id="MaxSplit" id="flowchart-MaxSplit-139" class="node default"><rect stroke="url(#gradient)" height="72" width="233.1041717529297" y="-36" x="-116.55208587646484" data-id="MaxSplit" style="" class="basic label-container"/><g transform="translate(-86.55208587646484, -21)" style="" class="label"><rect/><foreignObject height="42" width="173.1041717529297"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>With maxsplit Parameter<br />'a,b,c'.split(',', 1) → ['a', 'b,c']</p></span></div></foreignObject></g></g><g transform="translate(553.34375, 553)" data-look="neo" data-et="node" data-node="true" data-id="Empty" id="flowchart-Empty-141" class="node default"><rect stroke="url(#gradient)" height="72" width="165.05208587646484" y="-36" x="-82.52604293823242" data-id="Empty" style="" class="basic label-container"/><g transform="translate(-52.52604293823242, -21)" style="" class="label"><rect/><foreignObject height="42" width="105.05208587646484"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>Empty Separator<br />'python'.split('')</p></span></div></foreignObject></g></g><g transform="translate(813.9270858764648, 553)" data-look="neo" data-et="node" data-node="true" data-id="Error" id="flowchart-Error-143" class="node default"><rect stroke="url(#gradient)" height="72" width="161.1666717529297" y="-36" x="-80.58333587646484" data-id="Error" style="" class="basic label-container"/><g transform="translate(-50.583335876464844, -21)" style="" class="label"><rect/><foreignObject height="42" width="101.16667175292969"><div xmlns="http://www.w3.org/1999/xhtml" style="display: table-cell; white-space: normal; line-height: 1.5; max-width: 200px; text-align: center;"><span class="nodeLabel"><p>ValueError:<br />empty separator</p></span></div></foreignObject></g></g></g></g></g><linearGradient y2="0%" x2="100%" y1="0%" x1="0%" gradientUnits="objectBoundingBox" id="export-svg-gradient"><stop stop-opacity="1" stop-color="hsl(0, 0%, 83.3333333333%)" offset="0%"/><stop stop-opacity="1" stop-color="hsl(0, 0%, 88.9215686275%)" offset="100%"/></linearGradient></svg>
            `
         }
      ],
      parameters: [
...
`,
    ...
    },
    {
      ...
      docstring: "Returns a list of the lines in the string, breaking at line boundaries.",
      extended_description: `@[splitlines]@ is a Python string method that splits string on line boundaries into a list of lines. Belongs to string partitioning family with [split](!/python/functions/split) and [rsplit](!/python/functions/rsplit), but specializes in line-based splitting. Works with [strip](!/python/functions/strip) for clean text processing and [join](!/python/functions/join) for line reconstruction. Handles universal line endings (\n, \r\n, \r). Optional keepends parameter preserves line terminators. Especially useful for processing text files, log parsing, and multiline string manipulation. Common in file I/O operations, text processing, and line-by-line analysis. Returns list of lines maintaining source format.
    ...
    },
    {
      ...
      docstring: "Returns True if string starts with the specified prefix, False otherwise.",
      extended_description: `@[startswith]@ is a Python string method that checks if string begins with specified prefix, returning True or False. Works with [endswith](!/python/functions/endswith) for comprehensive prefix/suffix validation. Accepts tuple of prefixes to check multiple options. Optional start and end parameters allow checking specific string portions. Partners with [strip](!/python/functions/strip) for clean comparisons and [find](!/python/functions/find) for more detailed prefix handling. Essential for file extension checking, protocol validation, and text pattern matching. Common in input validation and string filtering workflows.
    ...
    <!-- Original string box -->
    <rect x="50" y="40" width="500" height="80" rx="10" fill="white" stroke="#dee2e6" stroke-width="2" filter="url(#shadow)"/>
    <text x="70" y="30" font-family="Arial, sans-serif" font-size="16" fill="#495057">Original string: "   Hello World!   "</text>
    
    <!-- Individual characters in original -->
    <text x="70" y="85" font-family="Arial, sans-serif" font-size="24" fill="#6c757d">
        <tspan x="70">"</tspan>
        <tspan x="90" fill="#a2d2ff">␣</tspan>
        <tspan x="110" fill="#a2d2ff">␣</tspan>
        <tspan x="130" fill="#a2d2ff">␣</tspan>
        <tspan x="150">H</tspan>
        <tspan x="170">e</tspan>
        <tspan x="190">l</tspan>
        <tspan x="210">l</tspan>
        ...
        <tspan x="350">d</tspan>
        <tspan x="370">!</tspan>
        <tspan x="390" fill="#a2d2ff">␣</tspan>
        <tspan x="410" fill="#a2d2ff">␣</tspan>
        <tspan x="430" fill="#a2d2ff">␣</tspan>
        <tspan x="450">"</tspan>
    </text>
    
    <!-- Arrows indicating strip operation -->
    <path d="M120,130 L120,170" fill="none" stroke="#ff758f" stroke-width="2" marker-end="url(#arrowhead)"/>
    <path d="M410,130 L410,170" fill="none" stroke="#ff758f" stroke-width="2" marker-end="url(#arrowhead)"/>
    
    <!-- Arrow marker definition -->
    <defs>
        <marker id="arrowhead" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
            <polygon points="0 0, 10 3.5, 0 7" fill="#ff758f"/>
        </marker>
        <filter id="shadow" x="-0.5" y="-0.5" width="2" height="2">
            <feDropShadow dx="2" dy="2" stdDeviation="2" flood-color="#adb5bd" flood-opacity="0.5"/>
        </filter>
    </defs>
    
    <!-- Result string box -->
    <rect x="50" y="190" width="500" height="80" rx="10" fill="white" stroke="#dee2e6" stroke-width="2" filter="url(#shadow)"/>
    <text x="70" y="180" font-family="Arial, sans-serif" font-size="16" fill="#495057">After strip(): "Hello World!"</text>
    
    <!-- Individual characters in result -->
    <text x="70" y="235" font-family="Arial, sans-serif" font-size="24" fill="#6c757d">
        <tspan x="70">"</tspan>
        <tspan x="90">H</tspan>
        <tspan x="110">e</tspan>
        <tspan x="130">l</tspan>
    ...
    <!-- Legend -->
    <rect x="50" y="290" width="15" height="15" fill="#a2d2ff" rx="3"/>
    <text x="75" y="305" font-family="Arial, sans-serif" font-size="14" fill="#495057">Whitespace removed by strip()</text>
    <path d="M220,270 L220,300" fill="none" stroke="#ff758f" stroke-width="2" marker-end="url(#arrowhead)"/>
</svg>`,
explanation:"This is first explanation"}
      ...
      docstring: "Returns a copy of the string with leading and trailing characters removed.",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a copy of the string with uppercase characters converted to lowercase and vice versa.",
      extended_description:`@[swapcase]@ is a Python string method that inverts character case - lowercase becomes uppercase and vice versa. Works as complement to [upper](!/python/functions/upper) and [lower](!/python/functions/lower) in text transformations. Unlike [title](!/python/functions/title) and [capitalize](!/python/functions/capitalize) which follow specific patterns, it simply toggles existing case. Often used with [strip](!/python/functions/strip) for text cleanup and [casefold](!/python/functions/casefold) for Unicode handling. Useful in text processing, pattern matching, and special text effects. Creates new string instance preserving original data.
`,
      decorators: [],
      main_category: "String Operations",
      sub_category: "Case Conversion",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a titlecased version of the string where words start with an uppercase character and the remaining characters are lowercase.",
    ...
    },
    {
      ...
      docstring: "Returns a copy of the string in which each character has been mapped through the given translation table.",
    ...
    },
    {
      ...
      parameters: [],
      docstring: "Returns a copy of the string converted to uppercase.",
      extended_description: `@[upper]@ is a Python string method that converts all characters to uppercase. Essential for text standardization, data processing, and case-insensitive comparisons. Partners with [lower](!/python/functions/lower) for case transformations and often used with [title](!/python/functions/title) and [capitalize](!/python/functions/capitalize) in text formatting workflows. Works alongside [strip](!/python/functions/strip) for text cleanup and [casefold](!/python/functions/casefold) for Unicode handling. [swapcase](!/python/functions/swapcase) offers complementary case switching functionality. The method is crucial for ensuring consistency in user inputs, database queries, and text normalization tasks. Creates a new string instance, preserving the original, making it safe for immutable string operations.
    ...
    },
    {
      ...
      docstring: "Returns a list of valid attributes for the given object.",
    ...
    },
    {
      ...
      docstring: "Returns a copy of the string left filled with ASCII '0' digits to make a string of length width.",
