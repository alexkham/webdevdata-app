// Emulator for Python str.encode(encoding='utf-8').
...
export default function strEncode(s, encoding = 'utf-8') {
  if (typeof s !== 'string') throw new TypeError('encode() argument must be str');
  return { __pyRaw: bytesRepr(encodeBytes(s, encoding === null ? 'utf-8' : encoding)) };
}
