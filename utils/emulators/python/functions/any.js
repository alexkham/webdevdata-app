// utils/emulators/python/any.js
//
// Emulator for Python any(iterable). Truthiness rules match Python's:
// 0, 0.0, "", None (null), False, empty list/dict are all falsy.
// Short-circuits on the first truthy item.
...
export default function pyAny(iterable) {
