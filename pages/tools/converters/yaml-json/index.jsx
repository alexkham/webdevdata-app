...
//   const keyWords=['yaml to json converter', 'json to yaml converter','yaml to json online']
//   return (
//     <Layout>
...
//           <link rel="canonical" href="https:/www.webdevdata.net/tools/converters/yaml-json" />
...
export async function getStaticProps() {
  const metadata = {
    title: "YAML to JSON Converter | Convert Between YAML and JSON - WebDevData",
    description: "Free online YAML to JSON and JSON to YAML converter. Easily convert data between YAML and JSON formats. Essential tool for developers and data analysts.",
    keywords: ['yaml to json converter', 'json to yaml converter', 'yaml to json online', 'yaml editor', 'json editor', 'yaml validation', 'json validation'],
    url: "https://www.webdevdata.net/tools/converters/yaml-json",
  }
...
export default function YamlJsonConverterPage({ metadata, explanations }) {
  return (
    <Layout>
      <div className={styles.page}>
        <Head>
