  ...
  return (
    <Layout>
      <Head>
        ...
        <meta property="og:url" content="https://www.webdevdata.net/tools/converters" />
        <link rel="canonical" href="https:/www.webdevdata.net/tools/converters" />
...
export async function getStaticProps() {
  const cardsData = [
...

    {
      ...
      {
        title: "JSON to JS Object Converter",
        content:"Convert JSON data to JS format. Ensure your data is compatible across different systems and APIs, facilitating smooth integration and data exchange.",
        link: "/tools/converters/json-js",
        color: "#f0f0f0"
      },
      {
